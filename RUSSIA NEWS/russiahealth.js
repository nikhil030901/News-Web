...
let apiKey = '0f725c2b380b414bac120e8839bbc9e2'
...
let newsadding1= document.getElementById('item1');
  ...
  xhr.open('GET', `https://newsapi.org/v2/top-headlines?country=${source}&category=${category}&apiKey=${apiKey}&pageSize=100`, true);
